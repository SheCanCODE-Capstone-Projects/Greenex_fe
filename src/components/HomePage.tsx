...
const Home = () => {
  ...
  const isActive = (path: string) =>
    pathname === path
      ? "underline underline-offset-8 text-emerald-300"
      : "";
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#0c351f]/80" />
      ...
      >
        <div className="flex flex-col items-center gap-4 text-xl font-medium p-4 w-full max-w-xs">
          <Link onClick={() => setMenuOpen(false)} className="hover:text-emerald-300 transition py-2 w-full text-center" href="/">Home</Link>
          <Link onClick={() => setMenuOpen(false)} className="hover:text-emerald-300 transition py-2 w-full text-center" href="/about">About</Link>
          <Link onClick={() => setMenuOpen(false)} className="hover:text-emerald-300 transition py-2 w-full text-center" href="/services">Services</Link>
          <Link onClick={() => setMenuOpen(false)} className="hover:text-emerald-300 transition py-2 w-full text-center" href="/contact">Contact Us</Link>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-10 px-4">
        ...
        <p className="text-white text-lg sm:text-xl md:text-2xl lg:text-3xl font-light opacity-90 mb-10 px-4">
          Cleaner waste management
        </p>

        <div className="flex justify-center items-center flex-col sm:flex-row gap-4 sm:gap-6 px-4">
          <button className="bg-[#25b86a] text-white px-10 py-3 rounded-2xl text-lg hover:bg-[#1f9c58] transition shadow-xl font-medium">
            Get Started
          </button>

          <button className="border-2 border-white text-white px-10 py-3 rounded-xl font-medium text-lg hover:bg-white/10 transition">
            Learn More
          </button>
        </div>
      </div>
